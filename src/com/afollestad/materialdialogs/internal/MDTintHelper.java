...
public class MDTintHelper {
    ...
    public static void setTint(@NonNull RadioButton radioButton, @ColorInt int color) {
        ColorStateList sl = new ColorStateList(new int[][]{
                ...
                DialogUtils.resolveColor(radioButton.getContext(), RX.attr.colorControlNormal),
                color
        });
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            radioButton.setButtonTintList(sl);
        } else {
            Drawable radioDrawable = ContextCompat.getDrawable(radioButton.getContext(), RX.drawable.abc_btn_radio_material);
    ...
    private static ColorStateList createEditTextColorStateList(@NonNull Context context, @ColorInt int color) {
        ...
        colors[i] = DialogUtils.resolveColor(context, RX.attr.colorControlNormal);
        i++;
    ...
    public static void setTint(@NonNull CheckBox box, @ColorInt int color) {
        ColorStateList sl = new ColorStateList(new int[][]{
                ...
                DialogUtils.resolveColor(box.getContext(), RX.attr.colorControlNormal),
                color
        });
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            box.setButtonTintList(sl);
        } else {
            Drawable checkDrawable = ContextCompat.getDrawable(box.getContext(), RX.drawable.abc_btn_check_material);
