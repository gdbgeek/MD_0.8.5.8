...
public class MaterialEditTextPreference extends EditTextPreference {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        fallback = DialogUtils.resolveColor(context, RX.attr.colorAccent, fallback);
        mColor = DialogUtils.resolveColor(context, RX.attr.md_widget_color, fallback);
    ...
    protected void showDialog(Bundle state) {
        ...
        View layout = LayoutInflater.from(getContext()).inflate(RX.layout.md_stub_inputpref, null);
