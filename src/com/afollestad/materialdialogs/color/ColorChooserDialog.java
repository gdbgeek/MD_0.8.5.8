...
public class ColorChooserDialog extends DialogFragment implements View.OnClickListener, View.OnLongClickListener {
    ...
    private int getSelectedColor() {
        ...
        if (color == 0) {
            ...
            color = DialogUtils.resolveColor(getActivity(), RX.attr.colorAccent, fallback);
        }
        return color;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mCircleSize = getResources().getDimensionPixelSize(RX.dimen.md_colorchooser_circlesize);
        final Builder builder = getBuilder();

        MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                .title(getTitle())
                .autoDismiss(false)
                .customView(RX.layout.md_dialog_colorchooser, false)
        ...
        mGrid = (GridView) v.findViewById(RX.id.grid);

        if (builder.mAllowUserCustom) {
            mSelectedCustomColor = preselectColor;
            mColorChooserCustomFrame = v.findViewById(RX.id.colorChooserCustomFrame);
            mCustomColorHex = (EditText) v.findViewById(RX.id.hexInput);
            mCustomColorIndicator = v.findViewById(RX.id.colorIndicator);
            mCustomSeekA = (SeekBar) v.findViewById(RX.id.colorA);
            mCustomSeekAValue = (TextView) v.findViewById(RX.id.colorAValue);
            mCustomSeekR = (SeekBar) v.findViewById(RX.id.colorR);
            mCustomSeekRValue = (TextView) v.findViewById(RX.id.colorRValue);
            mCustomSeekG = (SeekBar) v.findViewById(RX.id.colorG);
            mCustomSeekGValue = (TextView) v.findViewById(RX.id.colorGValue);
            mCustomSeekB = (SeekBar) v.findViewById(RX.id.colorB);
            mCustomSeekBValue = (TextView) v.findViewById(RX.id.colorBValue);

            if (!builder.mAllowUserCustomAlpha) {
                v.findViewById(RX.id.colorALabel).setVisibility(View.GONE);
    ...
    private void invalidate() {
        if (mGrid.getAdapter() == null) {
            ...
            mGrid.setSelector(ResourcesCompat.getDrawable(getResources(), RX.drawable.md_transparent, null));
    ...
    public static class Builder implements Serializable {
        ...
        @StringRes
        protected int mDoneBtn = RX.string.md_done_label;
        @StringRes
        protected int mBackBtn = RX.string.md_back_label;
        @StringRes
        protected int mCancelBtn = RX.string.md_cancel_label;
        @StringRes
        protected int mCustomBtn = RX.string.md_custom_label;
        @StringRes
        protected int mPresetsBtn = RX.string.md_presets_label;
        @Nullable
