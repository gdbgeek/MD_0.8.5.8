...
class DefaultAdapter extends BaseAdapter {
    ...
    public View getView(final int index, View view, ViewGroup parent) {
        ...
        TextView tv = (TextView) view.findViewById(RX.id.title);
        switch (dialog.listType) {
            case SINGLE: {
                @SuppressLint("CutPasteId")
                RadioButton radio = (RadioButton) view.findViewById(RX.id.control);
            ...
            case MULTI: {
                @SuppressLint("CutPasteId")
                CheckBox checkbox = (CheckBox) view.findViewById(RX.id.control);
