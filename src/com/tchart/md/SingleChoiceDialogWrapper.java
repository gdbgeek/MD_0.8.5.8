...
@BA.ShortName("MD_SingleChoiceDialog")
@ActivityObject

@Events(values={"ButtonPress(Result As Int)", "Show", "Cancel", "Dismiss","SingleChoice(Index As Int, Text As String)"})

public class SingleChoiceDialogWrapper
{	
	private BA ba;
	...
	public void Show(String title, List items, int selectedIndex, String positiveText, String negativeText)
	{
		...
		if (ba.subExists(EventName + "_singlechoice"))
		{
